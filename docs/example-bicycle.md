---
title: Example Bicycle Module
description: Generated Markdown for the Bicycle group in the bundled example
---
...
[Bicycle](#classtransport_1_1Bicycle) implements a standard bicycle. Bicycles are a useful way of transporting oneself without too much effort, unless you go uphill or ride into the wind. If there are a lot of people on the road, you can use `RingBell` to ring your bell.

## Summary

Members | Descriptions
--- | ---
`public virtual void `[`PedalHarder`](#classtransport_1_1Bicycle_1a7df6cce8f18012fb07bef5be9dadd8ef)`()` | PedalHarder makes you go faster.
`public virtual void `[`RingBell`](#classtransport_1_1Bicycle_1a7d2be572f09c78b4d4ae38ef22f3e98b)`()` | Ring the bell on the bike.
